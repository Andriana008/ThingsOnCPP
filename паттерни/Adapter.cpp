...
/*5. Патерн Адаптер. Нехай деякий сенсор дає змогу отримувати покази 
температури в градусах Фаренгейтах, а клієнт користується інтерфейсом 
для отримання температури  в градусах Цельсія.
 Написати адаптер для розв’язання цього конфлікту*/
